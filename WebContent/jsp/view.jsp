		  ...
		  <tr>
			<td align="right"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
				  ...
				  <td width="241" align="right"><img src="images/button/but_answer.gif" width="56" height="21" onClick="JavaScript:location.href='answer.ajk?seq=${seq}&groups=${vo.groups }&step=${vo.step }&lev=${vo.lev }&nowPage=${param.nowPage }'" style="cursor:pointer">
					<img src="images/button/but_modify.gif" width="56" height="21" 
					onClick="javascript:location.href='update.ajk?seq=${vo.seq}&nowPage=${param.nowPage }'" style="cursor:pointer">
					<img src="images/button/but_list.gif" width="56" height="21"
					onClick="JavaScript:location.href='list.ajk?nowPage=${param.nowPage}'" style="cursor:pointer">
